...
<!--<?PHP echo(APP_LICENSE);?>-->  
  ...
  <meta name="description" content="Welcome to Placeroll! Let everyone have its place idea."/>
  <meta name="keywords" content="placeroll,photo,roll,on,premise,solution,NuMode"/>
...
<?php endif; ?>
   ...
   <div id="header" class="header" style="margin-top:18px;margin-bottom:18px;">
        <div style="float:left">
            <a href="/" target="_self" style="color:#000000; text-decoration: none;"><img id="piclogo" src="/res/AFlogo-biteidea.png" align="middle">&nbsp;<span id="avatarTitle">DDDD.ING</span></a>
        </div>
   </div>
